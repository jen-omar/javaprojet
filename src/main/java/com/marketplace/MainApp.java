...
public class MainApp extends Application {
    ...
    private VBox buildSidebar() {
        ...
        Label brandName = new Label("MARKETPLACE");
        brandName.setStyle("-fx-text-fill: #c9a84c; -fx-font-size: 16; -fx-font-weight: bold;");
        ...
        userPanel.setStyle("-fx-background-color: #1a1a1a; -fx-background-radius: 8; " +
                "-fx-border-color: #c9a84c; -fx-border-radius: 8; -fx-border-width: 1;");
        VBox.setMargin(userPanel, new Insets(0, 14, 20, 14));

        Label userName = new Label(session.getName());
        userName.setStyle("-fx-text-fill: #c9a84c; -fx-font-weight: bold; -fx-font-size: 13;");
    ...
    private void setActive(HBox item, Label iconLbl, Label labelLbl) {
        ...
        item.setStyle("-fx-background-color: #1a1a1a; " +
                "-fx-border-color: transparent transparent transparent #c9a84c; -fx-border-width: 3;");
        iconLbl.setStyle("-fx-text-fill: #c9a84c; -fx-font-size: 14; -fx-min-width: 24;");
        labelLbl.setStyle("-fx-text-fill: #c9a84c; -fx-font-size: 11; -fx-font-weight: bold;");
        activeNavItem  = item;
