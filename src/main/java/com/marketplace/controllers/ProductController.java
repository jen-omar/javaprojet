...
public class ProductController {
    ...
    private Node buildCard(Product p, FlowPane cards) {
        ...
        sub.setStyle("-fx-text-fill: #c9a84c; -fx-font-size: 12;");
    ...
    private Button createGoldButton(String t) {
        ...
        b.setStyle("-fx-background-color: #c9a84c; -fx-text-fill: #111; -fx-font-weight: bold; -fx-background-radius: 6; -fx-padding: 8 18 8 18; -fx-cursor: hand;");
        b.setOnMouseEntered(e -> b.setStyle("-fx-background-color: #e0be6a; -fx-text-fill: #111; -fx-font-weight: bold; -fx-background-radius: 6; -fx-padding: 8 18 8 18; -fx-cursor: hand;"));
        b.setOnMouseExited(e  -> b.setStyle("-fx-background-color: #c9a84c; -fx-text-fill: #111; -fx-font-weight: bold; -fx-background-radius: 6; -fx-padding: 8 18 8 18; -fx-cursor: hand;"));
        return b;
    }
        ...
        tf.focusedProperty().addListener((obs, wasF, isF) -> {
            ...
            if (!hasError) {
                String base = "-fx-control-inner-background: #2a2a2a; " +
                        ...
                        "-fx-prompt-text-fill: derive(-fx-control-inner-background, +80%); ";
                tf.setStyle(isF
                    ? base + "-fx-border-color: #c9a84c; -fx-border-width: 1.5; -fx-border-radius: 5; -fx-background-radius: 5; -fx-padding: 8;"
        ...
        ta.focusedProperty().addListener((obs, wasF, isF) -> {
            ...
            if (!hasError) {
                String base = "-fx-control-inner-background: #2a2a2a; " +
                        ...
                        "-fx-prompt-text-fill: derive(-fx-control-inner-background, +80%); ";
                ta.setStyle(isF
                    ? base + "-fx-border-color: #c9a84c; -fx-border-width: 1.5; -fx-border-radius: 5; -fx-background-radius: 5;"
