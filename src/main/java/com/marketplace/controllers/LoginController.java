...
public class LoginController {
    ...
    public VBox buildView(Runnable onLogin) {
        ...
        title.setStyle("-fx-text-fill: #c9a84c; -fx-font-size: 28; -fx-font-weight: bold; -fx-letter-spacing: 3;");
        ...
        loginBtn.setStyle("-fx-background-color: #c9a84c; -fx-text-fill: #111111; " +
                "-fx-font-weight: bold; -fx-font-size: 14; -fx-background-radius: 8; -fx-cursor: hand;");
        loginBtn.setOnMouseEntered(e -> loginBtn.setStyle(
                "-fx-background-color: #e0be6a; -fx-text-fill: #111111; " +
                        "-fx-font-weight: bold; -fx-font-size: 14; -fx-background-radius: 8; -fx-cursor: hand;"));
        loginBtn.setOnMouseExited(e -> loginBtn.setStyle(
                "-fx-background-color: #c9a84c; -fx-text-fill: #111111; " +
                        "-fx-font-weight: bold; -fx-font-size: 14; -fx-background-radius: 8; -fx-cursor: hand;"));
    ...
    private String activeToggleStyle() {
        return "-fx-background-color: #c9a84c; -fx-text-fill: #111111; -fx-font-weight: bold; " +
