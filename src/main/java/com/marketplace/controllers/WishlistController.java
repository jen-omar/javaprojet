...
public class WishlistController {
    ...
    private Node buildCard(Wishlist w, FlowPane cards) {
        ...
        prodLbl.setStyle("-fx-background-color: #2d2600; -fx-text-fill: #c9a84c; -fx-font-size: 12; " +
        ...
        if (prod != null && prod.getPrice() != null) {
            ...
            priceLbl.setStyle("-fx-text-fill: #c9a84c; -fx-font-size: 16; -fx-font-weight: bold;");
        }
