...
public class HomeController {
        ...
        private void buildAdminDashboard(VBox root) {
                ...
                stats.getChildren().addAll(
                                statCard("Produits", String.valueOf(nProducts), "≡", "#c9a84c"),
        ...
        private void buildArtistDashboard(VBox root) {
                ...
                welcome.setStyle("-fx-text-fill: #c9a84c; -fx-font-size: 24; -fx-font-weight: bold;");
                ...
                HBox stats = new HBox(14);
                stats.getChildren().addAll(
                                statCard("Mes Produits", String.valueOf(myProducts.size()), "≡", "#c9a84c"),
        ...
        private HBox prodRow(String name, String price, String type, String status, boolean isHeader) {
                ...
                Label lPrice = col(price, isHeader ? "#888" : "#c9a84c", 100);
        ...
        private VBox descCard(String icon, String title, String desc) {
                ...
                Label iconLbl = new Label(icon);
                iconLbl.setStyle("-fx-text-fill: #c9a84c; -fx-font-size: 14;");
                Label titleLbl = new Label(title);
                titleLbl.setStyle("-fx-text-fill: #c9a84c; -fx-font-weight: bold; -fx-font-size: 13;");
