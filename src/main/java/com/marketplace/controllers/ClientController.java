...
public class ClientController {
    ...
    public Node buildView() {
        ...
        title.setStyle(
                "-fx-text-fill: #c0c0c0; -fx-font-size: 26; -fx-font-weight: 900; -fx-font-family: 'Segoe UI Black';");
        ...
        chatHeader.setStyle(
                "-fx-background-color: linear-gradient(to right, #c9a84c, #8e732a); -fx-background-radius: 19 19 0 0;");

        VBox titleContainer = new VBox(2);
        Label chatTitle = new Label("MYTHORIA ASSISTANT");
        chatTitle.setStyle(
                "-fx-text-fill: #1a1a1a; -fx-font-weight: bold; -fx-font-size: 15; -fx-font-family: 'Segoe UI';");
        ...
        Runnable sendMessage = () -> {
            ...
            new Thread(() -> {
                ...
                Platform.runLater(() -> {
                    ...
                    nameTag.setStyle(
                            "-fx-text-fill: #8e732a; -fx-font-size: 9; -fx-font-weight: bold; -fx-padding: 0 0 0 5;");
    ...
    private VBox createQuizUI(StackPane mainContainer) {
        ...
        quizInput.setStyle(
                "-fx-background-color: #222; -fx-text-fill: white; -fx-border-color: #444; -fx-border-radius: 5;");

        Button submitQuiz = new Button("Vérifier");
        submitQuiz.setStyle(
                "-fx-background-color: #c9a84c; -fx-text-fill: black; -fx-font-weight: bold; -fx-cursor: hand;");
        ...
        submitQuiz.setOnAction(e -> {
            ...
            if ("van gogh".equalsIgnoreCase(ans)) {
                ...
                quizInput.setStyle(
                        "-fx-background-color: #222; -fx-text-fill: white; -fx-border-color: #ff6b6b; -fx-border-radius: 5;");
            }
        });
    ...
    private Node buildCard(Product p) {
        ...
        if (rawUrl != null && !rawUrl.isBlank()) {
            try {
                ...
                iv.setClip(new javafx.scene.shape.Rectangle(280, 160) {
                    {
                        setArcWidth(36);
                        setArcHeight(36);
                    }
        ...
        wishBtn.setStyle(
                "-fx-background-color: transparent; -fx-text-fill: #888; -fx-border-color: #444; -fx-border-radius: 10; -fx-cursor: hand;");
        wishBtn.setOnAction(e -> {
            ...
            wishBtn.setStyle(
                    "-fx-background-color: #333; -fx-text-fill: #7ec97e; -fx-border-color: #7ec97e; -fx-border-radius: 10;");
        });
    ...
    private void showBidDialog(Product p) {
        ...
        title.setStyle(
                "-fx-text-fill: #c0c0c0; -fx-font-size: 18; -fx-font-weight: 900; -fx-font-family: 'Segoe UI Black';");

        VBox historyBox = new VBox(10);
        historyBox.setPadding(new Insets(15));
        historyBox.setStyle(
                "-fx-background-color: #222; -fx-border-color: #333; -fx-border-radius: 12; -fx-background-radius: 12;");
    ...
    private void showBuyDialog(Product p) {
        ...
        summaryBox.setStyle(
                "-fx-background-color: #222; -fx-background-radius: 12; -fx-border-color: #333; -fx-border-radius: 12; -fx-border-width: 1;");
        ...
        confirmBtn.setOnAction(e -> {
            ...
            try {
                ...
                String url = stripeService.createCheckoutSession(p,
                        "http://localhost:" + paymentServer.getPort() + "/success",
                        "http://localhost:" + paymentServer.getPort() + "/cancel");
    ...
    private void showAvisDialog(Product p) {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            star.setStyle(
                    "-fx-background-color: transparent; -fx-text-fill: #555; -fx-font-size: 26; -fx-padding: 0 4; -fx-cursor: hand;");
            star.setOnAction(e -> {
                ...
                for (int j = 0; j < 5; j++) {
                    ...
                    stars[j].setStyle(
                            "-fx-background-color: transparent; -fx-text-fill: " + (filled ? "#c9a84c" : "#555")
                                    + "; -fx-font-size: 26; -fx-padding: 0 4; -fx-cursor: hand;");
                }
            });
            stars[i] = star;
        ...
        taComment.setStyle(
                "-fx-control-inner-background: #2a2a2a; -fx-text-fill: #fff; -fx-border-color: #444; -fx-border-radius: 5;");
    ...
    private void show3DMuseumView(Product product) {
        ...
        if (rawUrl != null && !rawUrl.isBlank()) {
            try {
                String urlStr = rawUrl.startsWith("http") || rawUrl.startsWith("file:") ? rawUrl
                        : "http://localhost" + rawUrl;
    ...
    private TextField clientField(String value) {
        ...
        tf.setStyle(
                "-fx-control-inner-background: #2a2a2a; -fx-text-fill: #fff; -fx-border-color: #444; -fx-padding: 8;");
        return tf;
    }
    ...
    private Button dialogOutlineBtn(String text) {
        Button b = new Button(text);
        b.setStyle(
                "-fx-background-color: transparent; -fx-text-fill: #ccc; -fx-border-color: #555; -fx-padding: 10 20;");
        return b;
    }
